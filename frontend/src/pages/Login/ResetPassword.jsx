    ...
    <div className="flex items-center justify-center min-h-screen bg-white">
      ...
      {!isEmailSent && (
        <form
          ...
          className="bg-white p-8 rounded-lg shadow-black shadow-2xl w-96 text-sm "
        >
          ...
          <button className="text-lg w-full py-2.5 bg-black text-white hover:scale-y-110 rounded-full mt-3 cursor-pointer">
            Submit
          </button>
        </form>
      )}
      ...
      {!isOtpSubmitted && isEmailSent && (
        ...
        >
          ...
          <button className="text-lg w-full py-2.5 bg-black text-white hover:scale-y-110 rounded-full cursor-pointer">
            Submit
          </button>
        </form>
      )}
