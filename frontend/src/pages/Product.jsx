      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            showcase their products, interact with customers, interact with
            ...
            their convenience, accessiblity, and the global reach they offer.
          </p>
          <p>
            E-commerce websites typically display products or services along
            with detailed descriptions, image, prices and any available
            variations (e,g., size, colors). Each product usually has its own
